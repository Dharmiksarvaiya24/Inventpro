      ...
      <div class="container">
        ...
        <div class="content-card">
          ...
          <div class="cta-section">
            <p class="cta-text">Start earning, start growing — your better lifestyle begins now!</p>
            <button @click="redirectToLogin" class="cta-button">Get Started</button>
          </div>
        </div>
      </div>
    </div>
